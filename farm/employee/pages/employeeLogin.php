...
<section class="vh-100">
  ...
  <div
    ...
    <div class="text-white mb-3 mb-md-0">
      Copyright © 2020. All rights reserved to <a href="../../template/index.php" class="text-danger">Faams</a>
    </div>
    <!-- Copyright -->
...
<?php
    ...
    if (isset($_POST["btn"])) {
        ...
        $login_query = "select * from tbl_employee where emp_email = '$log_email' and emp_password='$log_pass' and emp_status='approved'";
        $run_login = mysqli_query($conn, $login_query);
        $check_record = mysqli_num_rows($run_login);
        if ($check_record == 1) {
            $data_uthao = mysqli_fetch_array($run_login);
            $_SESSION["ename"] = $data_uthao[1];
            $_SESSION["image"] = $data_uthao[8];
            $_SESSION["eid"] = $data_uthao[0];
